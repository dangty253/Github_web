	...
	<tr>
		<td>
			...
			<table class="xntt col-md-12 col-xs-4">
				...
				<tr>
					<td><input  type="text" name="Hokh" value="<?php if ($kh!="") echo mb_substr($kh['HoTen'],0,$k-1) ?>" class="form-control" required></td>
					<td><input type="text" name="Tenkh" value="<?php if ($kh!="") echo mb_substr($kh['HoTen'],$k) ?>" class="form-control" required></td>
				</tr>
				<tr>
					<td>Số điện thoại </td>
					<td>Email</td>
				...
				<tr>
					<td><input type="text" name="Sdt" value="<?php if ($kh!="") echo $_SESSION["khachhang_data"]['SoDienThoai']; ?>" class="form-control"></td>
					<td><input type="text" name="Email" value="<?php if ($kh!="") echo $_SESSION["khachhang_data"]['Email']; ?>" class="form-control"></td>
				</tr>
			</table>
		...
		<td class="xntt col-md-12 col-xs-4" >
			<?php
