...
if (isset($_SESSION["khachhang_data"]))
{
	...
	<table align="center" width="60%" class="dangnhap">
		<tr>
			<td>UserName</td>
			<td><input type="text" name="username" id="Username" value="<?php echo $_SESSION["khachhang_data"]["username"] ?>" disabled="disabled"></td>
		</tr>
		<tr>
			<td>Mật khẩu cũ</td>
		...
		<tr>
			<td>Họ tên</td>
			<td> <input type="text" name="HoTen" value="<?php echo $_SESSION["khachhang_data"]["HoTen"] ?>"></td>
		</tr> 
		<tr>
			<td>Địa chỉ</td>
			<td> <input type="text" name="DiaChi" value="<?php echo $_SESSION["khachhang_data"]["DiaChi"] ?>"></td>
		</tr>
		<tr>
			<td>Số điện thoại</td>
			<td> <input type="text" name="SoDienThoai" value="<?php echo $_SESSION["khachhang_data"]["SoDienThoai"] ?>"></td>
		</tr>
			<tr>
			<td>Email</td>
			<td> <input type="text" name="Email" value="<?php echo $_SESSION["khachhang_data"]["Email"] ?>"></td>
		</tr>
		<tr>
			<td colspan="2" style="text-align: center;"><input type="submit" name="sm" value="  Lưu thay đổi "></td>
		</tr>
	</table>
	</form>
<?php
