...
('admin', 'e10adc3949ba59abbe56e057f20f883e', 'Tý', '0359720087', 'dangty253@gmail.com'),
('lam', 'e10adc3949ba59abbe56e057f20f883e', 'Lâm', '45531546', 'lam@gamil.com'),
...
ALTER TABLE `chuyenbay`
  ...
  ADD KEY `fk_ChuyenBay_TuyenBay_1` (`MaTuyenBay`);

--
-- Indexes for table `ghe`
--
ALTER TABLE `ghe`
  ADD KEY `fk_Ghe_MayBay_1` (`MaMayBay`),
  ADD KEY `fk_Ghe_HangGhe_1` (`MaHangGhe`);

--
-- Indexes for table `giave`
--
ALTER TABLE `giave`
  ADD KEY `fk_GiaVe_HangGhe_1` (`MaHangGhe`),
  ADD KEY `fk_GiaVe_ChuyenBay_1` (`MaChuyenBay`);

--
-- Indexes for table `hangghe`
--
ALTER TABLE `hangghe`
  ADD PRIMARY KEY (`MaHangGhe`);
...
ALTER TABLE `maybay`
  ...
  ADD KEY `fk_MayBay_HangMayBay_1` (`MaHangMayBay`);
...
ALTER TABLE `phieudat`
  ...
  ADD KEY `fk_PhieuDat_KhachHang_1` (`username`);
...
ALTER TABLE `thanhtoan`
  ...
  ADD KEY `fk_ThanhToan_PhieuDat_1` (`MaPhieuDat`);
...
ALTER TABLE `tuyenbay`
  ...
  ADD KEY `fk_TuyenBay_SanBay_1` (`MaSanBayDi`),
  ADD KEY `fk_TuyenBay_SanBay_2` (`MaSanBayDen`);
...
ALTER TABLE `ve`
  ...
  ADD KEY `fk_Ve_ChuyenBay_1` (`MaChuyenBay`),
  ADD KEY `fk_Ve_PhieuDat_1` (`MaPhieuDat`);
...
--
ALTER TABLE `ve`
  MODIFY `MaVe` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
